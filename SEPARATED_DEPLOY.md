...
- `proyecto-liquibase`
- `proyecto-backend` 
- `proyecto-frontend` https://github.com/joseale879/proyecto-frontend

Todos se conectan por la red Docker: `api_app-network`.

## Repositorios Git

- `proyecto-liquibase`: `https://github.com/EmersonMolano/proyecto-liquibase.git`
- `proyecto-backend`: `https://github.com/EmersonMolano/proyecto-frontend.git`
- `proyecto-frontend`: `https://github.com/EmersonMolano/proyecto-frontend.git`
